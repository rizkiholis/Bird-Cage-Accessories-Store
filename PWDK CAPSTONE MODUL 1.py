...
daftar_barang= [   
    [101,"Mur Topi ","Alumunium",0.6,90,1150],
    [102,"Mur Kuping ","Plat Besi",1.2,50,1300],
    [103,"Lonceng ","Plat Besi",0.4,100,1200],
    [104,"Mangkok Kembang","Plat Kaleng",0.2,95,1150],
    [105,"Mangkok Bulat ","Plat Kaleng",0.2,80,1175]
]
...
def user_beli():
    ...
    while True:
        ...
        try:      
            ...
            print("\n*** Pilihan tidak valid! Mohon masukan dengan ID yang benar.***")
            continue
...
def create_menu():
    while True:
        ...
        if pilih == 1 :
            ...
            if id_ditemukan == False : # proses akan dilanjutkan jika jika id belum ditemukan
                try:
                    ...
                    print("\n*** Pilihan tidak valid! Mohon masukan dengan angka yang benar.***")
                    continue #agar bisa mencoba lagi
                try:
